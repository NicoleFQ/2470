...
public class ShowShape extends JApplet {
	...
	public void init() {
		...
		if ((tempXString!= null) && (Integer.parseInt(tempXString) <= this.appletX)) {
			this.XSize = Integer.parseInt(tempXString);
			this.startX = (this.appletX - XSize) / 2;
			XSizeCheck = true;
		}
		if ((tempYString!= null) && (Integer.parseInt(tempYString) <= this.appletY)) {
			this.YSize = Integer.parseInt(tempYString);
			this.startY = (this.appletY - YSize) / 2;
			YSizeCheck = true;
		}
